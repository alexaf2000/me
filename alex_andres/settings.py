"""
Django settings for alex_andres project.
...
SECRET_KEY = 'rg3ful5yt6bu8vqmzsjt8%qh@+na3q1y9$dt0#g_ir9tu!^lye'
...
WSGI_APPLICATION = 'alex_andres.wsgi.application'
